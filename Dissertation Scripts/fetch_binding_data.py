##########################################################################################################
# This is a slightly modified version of Mile's script to extract binding data from all three databases. # 
# It returns binding data for all ligands converted to uM and prioritising the right databses            #
##########################################################################################################

# command used to run:
# "python3 fetch_binding_data.py -irid /home/s2451611/MScProject/binding_data/Iridium_DOI_DPI_RES.xls -pdb /home/s2451611/MScProject/binding_data/INDEX_refined_data.2020 -moad /home/s2451611/MScProject/binding_data/nr_bind.csv -pdbqt /home/s2451611/MScProject/pdbqt_aligned_ligands/ -threshold 25 -out /home/s2451611/MScProject/binding_data.csv"
...
def load_moad(binding_moad_data): # load binding data from Binding MOAD dataset into dataframe
    ...
    binding_df.to_csv('bindingmoad.csv')
...
def search_for_binding_data(master_df, pdbqt_files_path): # assign binding data to each structure in our dataset and return a dataframe
    ...
    structures = [f.split('_')[0] for f in os.listdir(pdbqt_files_path) if f.endswith('.pdbqt')]
    ...
    binding_data_final.to_csv("binding_data_final.csv")
